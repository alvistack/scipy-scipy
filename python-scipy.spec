...
BuildRequires: pybind11-devel >= 2.10.4
BuildRequires: python-rpm-macros
BuildRequires: python3-cython >= 0.29.35
BuildRequires: python3-decorator
BuildRequires: python3-devel
BuildRequires: python3-meson-python >= 0.12.1
BuildRequires: python3-numpy >= 1.22.3
BuildRequires: python3-numpy-f2py >= 1.22.3
BuildRequires: python3-pybind11 >= 2.10.4
BuildRequires: python3-pythran >= 0.12.0
...
set -ex && \
    ...
    export LDFLAGS="%{build_ldflags} -Wl,--no-as-needed -lmvec -Wl,--as-needed" && \
