...
/* "scipy/signal/_max_len_seq_inner.pyx":14
...
static PyObject *__pyx_pw_5scipy_6signal_18_max_len_seq_inner_1_max_len_seq_inner(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_max_len_seq_inner (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_state)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_max_len_seq_inner", 1, 5, 5, 1); __PYX_ERR(0, 14, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_nbits)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_max_len_seq_inner", 1, 5, 5, 2); __PYX_ERR(0, 14, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_length)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_max_len_seq_inner", 1, 5, 5, 3); __PYX_ERR(0, 14, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seq)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_max_len_seq_inner", 1, 5, 5, 4); __PYX_ERR(0, 14, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_max_len_seq_inner") < 0)) __PYX_ERR(0, 14, __pyx_L3_error)
      }
    ...
    __pyx_v_taps = __Pyx_PyObject_to_MemoryviewSlice_dc_Py_ssize_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_taps.memview)) __PYX_ERR(0, 14, __pyx_L3_error)
    __pyx_v_state = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_int8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_state.memview)) __PYX_ERR(0, 15, __pyx_L3_error)
    __pyx_v_nbits = __Pyx_PyIndex_AsSsize_t(values[2]); if (unlikely((__pyx_v_nbits == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_length = __Pyx_PyIndex_AsSsize_t(values[3]); if (unlikely((__pyx_v_length == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 16, __pyx_L3_error)
    __pyx_v_seq = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_int8_t(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_seq.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_max_len_seq_inner", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 14, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  ...
  /* "scipy/signal/_max_len_seq_inner.pyx":32
 *         idx = (idx + 1) % nbits
 *     # state must be rolled s.t. next run, when idx==0, it's in the right place
 *     return np.roll(state, -idx, axis=0)             # <<<<<<<<<<<<<<
 */
  ...
  __pyx_t_10 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_roll); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = __pyx_memoryview_fromslice(__pyx_v_state, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_int8_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_int8_t, 0);; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_11 = PyInt_FromSsize_t((-__pyx_v_idx)); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 32, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_11);
  if (PyDict_SetItem(__pyx_t_11, __pyx_n_s_axis, __pyx_int_0) < 0) __PYX_ERR(0, 32, __pyx_L1_error)
  __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_10, __pyx_t_12, __pyx_t_11); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
 ...
 *                        Py_ssize_t nbits, Py_ssize_t length,
 */
  __pyx_tuple__22 = PyTuple_Pack(10, __pyx_n_s_taps, __pyx_n_s_state, __pyx_n_s_nbits, __pyx_n_s_length, __pyx_n_s_seq, __pyx_n_s_n_taps, __pyx_n_s_idx, __pyx_n_s_feedback, __pyx_n_s_i, __pyx_n_s_ti); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 14, __pyx_L1_error)
 ...
 */
  ...
  /* "scipy/signal/_max_len_seq_inner.pyx":8
 * cimport cython
 * 
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 *                        Py_ssize_t nbits, Py_ssize_t length,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5scipy_6signal_18_max_len_seq_inner_1_max_len_seq_inner, NULL, __pyx_n_s_scipy_signal__max_len_seq_inner); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_max_len_seq_inner, __pyx_t_1) < 0) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
