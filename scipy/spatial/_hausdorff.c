 ...
 */
  ...
  __pyx_t_3 = PyFloat_FromDouble(sqrt(__pyx_v_cmax)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_24 = __pyx_v_i_ret;
  if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_pybuffernd_resort1.diminfo[0].shape;
  __pyx_t_5 = __Pyx_PyInt_From_npy_int64((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_int64_t *, __pyx_pybuffernd_resort1.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_resort1.diminfo[0].strides))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_24 = __pyx_v_j_ret;
  if (__pyx_t_24 < 0) __pyx_t_24 += __pyx_pybuffernd_resort2.diminfo[0].shape;
  __pyx_t_4 = __Pyx_PyInt_From_npy_int64((*__Pyx_BufPtrCContig1d(__pyx_t_5numpy_int64_t *, __pyx_pybuffernd_resort2.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_resort2.diminfo[0].strides))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
